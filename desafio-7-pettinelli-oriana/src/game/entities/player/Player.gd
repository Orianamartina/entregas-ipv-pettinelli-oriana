...
var _sounds: Dictionary = {
	&"jump": preload("res://assets/sounds/jump.mp3"),
	&"walk": preload("res://assets/sounds/walk.mp3"),
	&"attack": preload("res://assets/sounds/attack.mp3"),
	&"hurt": preload("res://assets/sounds/player_hurt.mp3"),
}

func _play_sound(sound_name: StringName) -> void:
	if _sounds.has(sound_name):
		sound.stream = _sounds[sound_name]
		sound.play()
