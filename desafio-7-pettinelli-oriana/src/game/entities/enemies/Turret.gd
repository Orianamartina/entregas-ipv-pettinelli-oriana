...
@onready var audio_player = $FXAudioPlayer
@onready var flying_audio_player = $FlyingAudioPlayer
var shoot_sound = preload("res://assets/sounds/enemy_shoot.mp3")
var flying_sound = preload("res://assets/sounds/enemy-flying.mp3")
var _sounds: Dictionary = {
	&"hurt": preload("res://assets/sounds/enemy_hurt.mp3"),
	&"die": preload("res://assets/sounds/enemy_die.mp3"),
}
...
func _play_sound(sound_name: StringName) -> void:
	if _sounds.has(sound_name):
		audio_player.stream = _sounds[sound_name]
		audio_player.play()


func _play_flying_sound() -> void:
	flying_audio_player.stream = flying_sound
	flying_audio_player.play()
